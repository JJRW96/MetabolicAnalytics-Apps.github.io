...
The application's calculations are based on the model presented by @Martin1998. The central function, `calculatePowerComponents()`, computes the various resistive forces and the power required to overcome them.
