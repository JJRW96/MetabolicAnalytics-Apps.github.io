...
eq_0watt_cubic <- sprintf("V̇O<sub>2,SS-0Watt</sub> = %.6f·Cadence<sup>3</sup> + %.2f", 
...
eq_0watt_cubic_linear <- sprintf("V̇O<sub>2,SS-0Watt</sub> = %.2f·Cadence + %.6f·Cadence<sup>3</sup> + %.2f", 
...
eq_0watt_parabolic <- sprintf("V̇O<sub>2,SS-0Watt</sub> = %.6f·Cadence<sup>2</sup> + %.2f·Cadence + %.2f", 
...
eq_200watt <- sprintf("V̇O<sub>2,SS-200Watt</sub> = %.2f·Cadence<sup>2</sup> + %.2f·Cadence + %.2f", 
